...
const invoiceFromDb = (r: Record<string, unknown>): Invoice => ({
  ...
  operatingExpense: Number(r.operating_expense) || 0,
  projectMeta: (r.project_meta as Invoice["projectMeta"]) || {},
...
const invoiceToDb = (i: Invoice, userId: string) => ({
  ...
  tax: i.tax || 0, discount: i.discount || 0, operating_expense: i.operatingExpense || 0,
  project_meta: i.projectMeta || {}, payments: i.payments || [],
});
