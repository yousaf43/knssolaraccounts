...
const buttonVariants = cva(
...

  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-[var(--shadow-glow)]",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-input bg-background/80 shadow-sm hover:border-primary/35 hover:bg-secondary hover:text-secondary-foreground",
