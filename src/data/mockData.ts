...
export const invoices: Invoice[] = [
  { id: "1", number: "INV-001", customer: "Acme Corp", date: "2025-01-15", dueDate: "2025-02-15", amount: 12500, status: "paid", items: [{ description: "Web Development", qty: 1, rate: 12500, amount: 12500 }] },
  { id: "2", number: "INV-002", customer: "TechStart Inc", date: "2025-01-20", dueDate: "2025-02-20", amount: 8750, status: "pending", items: [{ description: "UI Design", qty: 1, rate: 8750, amount: 8750 }] },
  { id: "3", number: "INV-003", customer: "Global Solutions", date: "2025-01-25", dueDate: "2025-02-10", amount: 15200, status: "overdue", items: [{ description: "Consulting", qty: 40, rate: 380, amount: 15200 }] },
  { id: "4", number: "INV-004", customer: "BlueSky Ltd", date: "2025-02-01", dueDate: "2025-03-01", amount: 6300, status: "paid", items: [{ description: "Maintenance", qty: 1, rate: 6300, amount: 6300 }] },
  { id: "5", number: "INV-005", customer: "Pinnacle Group", date: "2025-02-05", dueDate: "2025-03-05", amount: 22000, status: "pending", items: [{ description: "Software License", qty: 10, rate: 2200, amount: 22000 }] },
  { id: "6", number: "INV-006", customer: "Vertex Media", date: "2025-02-08", dueDate: "2025-02-22", amount: 4800, status: "overdue", items: [{ description: "Marketing Assets", qty: 1, rate: 4800, amount: 4800 }] },
];
